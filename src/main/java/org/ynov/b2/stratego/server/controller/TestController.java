...
public class TestController {
	...
	public HttpEntity<?> newGame() {
		...
		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(0, 3, Direction.HAUT, 1, startGames[0].getUuidTeam()));
		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(0, 6, Direction.BAS, 1, startGames[1].getUuidTeam()));
		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(0, 4, Direction.HAUT, 1, startGames[0].getUuidTeam()));

		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(1, 6, Direction.BAS, 1, startGames[1].getUuidTeam()));
		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(1, 3, Direction.HAUT, 1, startGames[0].getUuidTeam()));
		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(1, 5, Direction.BAS, 1, startGames[1].getUuidTeam()));

		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(4, 3, Direction.HAUT, 1, startGames[0].getUuidTeam()));
		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(4, 6, Direction.BAS, 1, startGames[1].getUuidTeam()));
		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(4, 4, Direction.HAUT, 1, startGames[0].getUuidTeam()));

		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(5, 6, Direction.BAS, 1, startGames[1].getUuidTeam()));
		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(5, 3, Direction.HAUT, 1, startGames[0].getUuidTeam()));
		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(5, 5, Direction.BAS, 1, startGames[1].getUuidTeam()));

		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(8, 3, Direction.HAUT, 1, startGames[0].getUuidTeam()));
		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(8, 6, Direction.BAS, 1, startGames[1].getUuidTeam()));
		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(8, 4, Direction.HAUT, 1, startGames[0].getUuidTeam()));

		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(9, 6, Direction.BAS, 1, startGames[1].getUuidTeam()));
		gameMessenger.play(startGames[0].getIdGame(),
				new ReceiveTurn(9, 3, Direction.HAUT, 1, startGames[0].getUuidTeam()));
		gameMessenger.play(startGames[1].getIdGame(),
				new ReceiveTurn(9, 5, Direction.BAS, 1, startGames[1].getUuidTeam()));
	...
	// lobbyMessager.enter(test1.getUuid(), pionsOne);
	// final PionType[][] pionsTwo = bouchonService.generateStarter();
	// final StartGame[] startGames = lobbyMessager.enter(test2.getUuid(),
	// pionsTwo);
	//
	// ResultTurn move = new ResultTurn();
	// int turn = 0;
	// while (move == null || move.getResult() == null
	// || (!move.getResult().equals(MoveResult.VICTORY) &&
	// !move.getResult().equals(MoveResult.DEFEAT))) {
	// final Integer idPlayer = startGames[turn % 2].getIdGame();
	// move = bouchonService.generateReceiveTurn();
